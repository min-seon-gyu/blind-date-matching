...
import { getNotifications, markNotificationAsRead } from '@/api/participant'
import EmptyState from '@/components/common/EmptyState'
import {
  ArrowLeft, Loader2, Bell, CheckCircle, XCircle, Heart,
  CalendarCheck, Clock, Receipt, Handshake, BellOff,
} from 'lucide-react'
            ...
            {notifications.map((notif) => (
              <button
                ...
                className={`w-full text-left rounded-2xl p-4 transition-colors ${
                  notif.isRead
                    ? 'bg-white'
                    : 'bg-[#FFF0F0] border border-[#FF6B6B]/10'
                } shadow-sm`}
              >
